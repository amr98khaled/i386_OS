...
namespace myos
{
    namespace hardwarecommunication
    {
        ...
        class InterruptManager
        {
            ...
            /* Declaring InterruptHandler as a friend class makes it possible for InterruptManager class to access all members (private and public) of InterrruptHandler class as if it were a member of that class . But note that InterruptHandler class can't access members of InterruptManager class , if you want to do so you must declare inside InterruptHandler class that InterruptManager is a friend class. */
        /*
        InterruptHandler* handlers[256] : array of interrupt handlers themselves.
        GateDescriptor interruptDescriptorTable[256] : array of entries to the handlers in the IDT .
        */
        protected:
            ...
            //structure for an entry in the IDT
            ...
            static void SetInterruptDescriptorTableEntry(myos::common::uint8_t interrupt, myos::common::uint16_t codeSegmentSelectorOffset, void (*handler)(), myos::common::uint8_t DescriptorPrivilegeLevel, myos::common::uint8_t DescriptorType);
        ...
        public:
            ...
            ~InterruptManager();
            myos::common::uint16_t HardwareInterruptOffset();                 //returns hardware interrupt offset
            void Activate();
            void Deactivate();
        };
    }
